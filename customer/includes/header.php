...
<div id="flipkart-navbar">
    <div class="container">
        <div class="row row1">
          <li class="upper-links"><a class="links" href="http://clashhacks.in/" style="float: left; font-size: 15px"> <?php   
            ...
            <ul class="largenav pull-right">
                ...
                <li class="upper-links <?php if($active=='Home') ?>"><a class="links" href="../index.php" >Home</a></li>
                <li class="upper-links" <?php if($active=='Shop')?>><a class="links" href="../shop.php">Shop</a></li>
                <li class="upper-links <?php if($active=='cart') ?>"><a class="links" href="../cart.php">My Cart</a></li>
                <li class="upper-links"<?php if($active=='Contact_Us') ?>><a class="links" href="../contact.php">Contact Us</a></li>
                <li class="upper-links <?php if($active=='Account') ?>"><a class="links" href="../customer_register.php">Customer Register</a></li>
                 <li class="upper-links"<?php if($active=='Account') ?>><a class="links" href="../contact.php">Customer Login</a></li>
                ...
                <li class="upper-links dropdown"><a class="links" href="my_account.php">My Account</a>
                    <ul class="dropdown-menu">
                        <li class="profile-li"><a class="profile-links" href="my_account.php?my_orders">My Orders</a></li>
                        <li class="profile-li"><a class="profile-links" href="my_account.php?edit_account">Edit Account</a></li>
                        <li class="profile-li"><a class="profile-links" href="my_account.php?change_pass">Change Password</a></li>
                        <li class="profile-li"><a class="profile-links" href="my_account.php?delete_Account">Delete Account</a></li>
     ...
     <a class="links"  <?php if($active=='Home') ?> href="../index.php" >Home</a></li>
               ...
               <a class="links" <?php if($active=='cart') ?> href="cart.php">My Cart</a></li>
                ...
                <a class="links" href="../admin-dashboard/login.php">Admin Login</a>
                 <li class="dropdown"><a class="links" href="my_account.php">My Account</a>
                    <ul class="dropdown-menu">
                        <li class="profile-li"><a class="profile-links" href="my_account.php?my_orders">My Orders</a></li>
                        <li class="profile-li"><a class="profile-links" href="my_account.php?edit_account">Edit Account</a></li>
                        <li class="profile-li"><a class="profile-links" href="my_account.php?change_pass">Change Password</a></li>
