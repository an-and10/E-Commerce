            ...
            <div class="panel-body"><!-- panel-body begin -->
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <td> <?php echo $date ?> </td>
                        <td><center><i class="fa fa-pencil"></i> <a href="index.php?edit_product=<?php echo $product_id  ?>"  style="text-align: center">Edit</a></center></td>
                        <td><i class="fa fa-trash-o"></i> <a href="index.php?delete_product=<?php echo $product_id  ?>" style="text-align: center;">Delete</a></td>
