    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
        ...
        <li class="dropdown"><!-- dropdown begin -->
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><!-- dropdown-toggle begin -->
                ...
                <i class="fa fa-user"></i> Anand Maurya <b class="caret"></b>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="p_cat" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?view_product_category"> View Products Categories </a>
                    </li><!-- li finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="slides" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?add_slides"> Add Slide </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_slides"> View Slides </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="#"> Delete Slides </a>
                    </li>
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_customer"><!-- a href begin -->
                    <i class="fa fa-fw fa-users"></i> View Customers
                </a><!-- a href finish -->
            </li><!-- li finish -->
            
            <li><!-- li begin -->
                <a href="index.php?view_order"><!-- a href begin -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="users" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?add_staff">Add Staff</a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_staff"> View Users </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
